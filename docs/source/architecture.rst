...
PEER's administrative features can be provisioned into the following four levels:
  ...
  * **Portal Super Admin** - this user(s) has the same administrative rights as the PEER Super Admin - '_except_' '_that_' the Portal Super Admin's rights are limited to just their organization's portals. Super Admins can grant rights to other super admin users, staff members and recommended researchers.  This includes the following General Permissions authority:
