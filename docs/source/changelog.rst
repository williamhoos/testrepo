...
* Prepared a .. _comprehensive inventory: https://www.dropbox.com/s/e6r9h7exmt1wzdb/PEER_INVENTORY_OUTLINE_v1.2.xlsx?dl=0'of all PEER components in Excel that can be filtered to explore specific components and the hierarchy of their respective operation
